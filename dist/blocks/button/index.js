...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/wp/5.8/block.json","apiVersion":2,"name":"bu/button","version":"0.0.3","title":"Button","description":"Prompt visitors to take action with a custom button.","category":"bu","icon":"block-default","textdomain":"bu-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style.css","render":"file:./render.php","attributes":{"anchor":{"type":"string"},"url":{"type":"string"},"text":{"type":"string"},"themeColor":{"type":"string"},"icon":{"type":"string"}},"styles":[{"name":"default","label":"Default","isDefault":true},{"name":"outline","label":"Outline"},{"name":"text","label":"Text"}],"supports":{"align":true,"anchor":true,"spacing":{"margin":true,"padding":true},"color":{"text":true,"background":true,"link":true,"gradients":true},"html":false,"__bublocks_colorthemes":true}}');
